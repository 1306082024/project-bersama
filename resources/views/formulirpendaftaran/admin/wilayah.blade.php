...
<!-- SIDEBAR -->
  <aside class="sidebar">
    <nav class="nav">
      ...
      <a href="wilayah1" class="nav-item active">
...
<main class="main">
  ...
  <div class="header">
    <div>
      <h2 style="margin:0">Kelola Wilayah</h2>
      <p style="margin:4px 0 0; color:var(--text-muted);">Atur wilayah cakupan internet.</p>
    </div>
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
    ...
    <div class="card">
      <h3 style="margin:0 0 10px;">Daftar Wilayah</h3>

      <table>
        <tbody>
          <tr><td>Klayan Tahap 1</td><td><button class="btn btn-danger">Hapus</button></td></tr>
          <tr><td>Klayan Tahap 2</td><td><button class="btn btn-danger">Hapus</button></td></tr>
          <tr><td>Klayan Tahap 3</td><td><button class="btn btn-danger">Hapus</button></td></tr>
          <tr><td>Klayan Tahap 4</td><td><button class="btn btn-danger">Hapus</button></td></tr>
          <tr><td>Klayan Tahap 5</td><td><button class="btn btn-danger">Hapus</button></td></tr>
        </tbody>
      </table>
    </div>

    <div class="card">
      <h3 style="margin:0 0 10px;">Tambah Wilayah Baru</h3>

      <label style="font-size:14px;color:#666;">Nama Wilayah</label>
      <input type="text">

      <button class="btn btn-primary" style="margin-top:12px; width:100%;">Simpan Wilayah</button>
    </div>
