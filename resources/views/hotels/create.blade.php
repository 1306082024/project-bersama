...
@section('header', 'Tambah Hotel')
@section('subheader', 'Tambahkan data hotel baru')
...
<div class="max-w-3xl mx-auto">
    ...
    <form method="POST"
          action="{{ route('super.admin.hotels.store') }}"
        ...
        <div>
            ...
            <input type="text"
                   ...
                   placeholder="Contoh: Hotel Grand Luxury"
        ...
        <div>
            ...
            <textarea name="alamat"
                      ...
                      class="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700
                             focus:ring-2 focus:ring-indigo-500 focus:outline-none">{{ old('alamat') }}</textarea>
            @error('alamat')
                <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
