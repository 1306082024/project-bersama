...
class AfoodController extends Controller
{
    public function index()
    {
        $orders = FoodOrder::with('room')->latest()->get();
        return view('makanan.aindex', compact('orders'));
    }

    public function create()
    {
        $rooms = Room::all();
        return view('makanan.acreate', compact('rooms'));
    }
    ...
    {
        $rooms = Room::all();
        return view('makanan.aedit', compact('foodOrder', 'rooms'));
    }
